...
public class AlertRepositoryTest
{
    ...
    public void testDelete() throws Exception
    {
        ...
        assertFalse(alertRepo.delete((AlertEntity) null));
        ...
        assertTrue(alertRepo.delete(newAlert));
        ...
        assertTrue(alertRepo.delete(newAlertTemperature));
        assertEquals(daoAlertTemp.countOf(), 0);
        assertEquals(daoAlert.countOf(), 0);
    ...
    public void testPersist() throws Exception
    {
        ...
        assertEquals(AlertTypeRepository.asAlertType(newAlInDb.getAlertType()), AlertType.TEMPERATURE);
