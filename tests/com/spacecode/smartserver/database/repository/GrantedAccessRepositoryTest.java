...
public class GrantedAccessRepositoryTest
{
    ...
    public void testPersist() throws Exception
    {
        ...
        GrantedAccessRepository gaRepo = (GrantedAccessRepository) DbManager.getRepository(GrantedAccessEntity.class);
        ...
        assertEquals(GrantTypeRepository.asGrantType(gaEntites.get(0).getGrantType()), GrantType.ALL);
    }
}