...
public class AlertTypeRepositoryTest
{
    @Before
    ...
    public void testAsAlertType() throws Exception
    {
        ...
        AlertTypeRepository gtRepo = (AlertTypeRepository) DbManager.getRepository(AlertTypeEntity.class);

        assertEquals(
                AlertTypeRepository.asAlertType(gtRepo.fromAlertType(AlertType.DEVICE_DISCONNECTED)),
                AlertType.DEVICE_DISCONNECTED);
        assertEquals(
                AlertTypeRepository.asAlertType(gtRepo.fromAlertType(AlertType.DOOR_OPEN_DELAY)),
                AlertType.DOOR_OPEN_DELAY);
        assertEquals(
                AlertTypeRepository.asAlertType(gtRepo.fromAlertType(AlertType.TEMPERATURE)),
                AlertType.TEMPERATURE);
        assertEquals(
                AlertTypeRepository.asAlertType(gtRepo.fromAlertType(AlertType.THIEF_FINGER)),
                AlertType.THIEF_FINGER);

        assertNull(AlertTypeRepository.asAlertType(null));
    }
